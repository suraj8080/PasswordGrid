...
import com.evontech.passwordgridapp.custom.mcustom.layout.CenterLayout;
...
public class LetterBoard extends CenterLayout implements Observer {
    ...
    public void scale(float scaleX, float scaleY) {
        if (mInitialized) {
            ...
            mGridLineBg.setLineWidth((int) Util.convertDpToPx(getContext(), 2));
            ...
            mLetterGrid.setLetterSize(Util.spToPx(15f, getContext()));
            if(mLetterGrid.getColCount()>18) mLetterGrid.setLetterSize(Util.spToPx(13f, getContext()));
    ...
    public void setDataAdapter(LetterGridDataAdapter dataAdapter, String type) {
        this.type = type;
        if (dataAdapter == null) {
            ...
            mLetterGrid.setDataAdapter(mData, type);
